...
//
//     public GamePhasee currentPhase = GamePhasee.Setup;
...
//
//             Debug.Log(
//                 $"Loaded: {stateDeck.Count} states, {institutionDeck.Count} institutions, {eventDeck.Count} events");
//         }
//         else
//         {
...
//
//             currentPhase = GamePhasee.MainGame;
//             StartTurn();
//         }
//
...
//         {
//             if (currentPhase != GamePhasee.MainGame) return;
//         
...
//             }
//
//             EventCard drawnEvent = null;
//
//             if (eventDeck.Count > 0)
//             {
//                 drawnEvent = eventDeck[0];
...
//                 {
//                     // AI or player decision handled elsewhere
//                     // For human players, UI will prompt
//                 }
//             }
//
//             return drawnEvent;
...
//         void StartCivilWar()
//         {
//             currentPhase = GamePhasee.CivilWar;
...
//                         currentPhase = GamePhasee.GameOver;
//                         yield break;
//                     }
//                 }
//
